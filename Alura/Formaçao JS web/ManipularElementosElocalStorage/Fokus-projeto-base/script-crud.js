...
function atualizarTarefas(){
    //localStorage - armazanamento local, so trabalha com string. JSON.stringify() converte objeto em string
...
function criarElementoTarefa(tarefa){
    ...
    //svg.addEventListener('click', tarefaConcluida)

    return li
}

btnAdicionarTarefa.addEventListener('click', toggleTarefas)

formAdiconarTarefa.addEventListener('submit', (evento) => {
    evento.preventDefault() //preventDefault() - previne um comportamento padrao 
    const tarefa = {
